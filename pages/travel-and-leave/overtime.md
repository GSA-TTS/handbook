...
- If you make the maximum salary ($191,900 in 2024), you cannot receive overtime or comp time. You can only be compensated with credit hours on a flexible schedule, which should be set up ahead of time.
...
You should use your accrued comp time before using Annual Leave. However, if the end of the leave year is approaching and you're in danger of losing Annual Leave because of “[Use or Lose]({% page "/travel-and-leave/leave/#annual-leave" %}), your supervisor can prioritize your Annual Leave requests over comp time.”

Comp time expires one year (26 pay periods) after it's earned. When you reach that expiration date, you forfeit the relevant leave. If you leave GSA, your comp time will be paid out.
...
Only people on [flexible work schedules]({% page "/general-information-and-resources/employee-resources-policies/work-schedules/#flexible-schedule" %}) can earn and use credit hours. There's no salary maximum for earning and using credit hours. To establish a flexible work schedule, talk with your supervisor.

You can then be approved for credit hours if you want to voluntarily work additional hours beyond your normal/approved schedule. If you are _required_ to work additional hours, you will receive overtime or comp time.

- You can have up to 24 credit hours accrued at any given time.

- The hours will roll over from one pay period to the next, and they never expire.
...
You're on a [Gliding schedule]({% page "/general-information-and-resources/employee-resources-policies/work-schedules/#gliding" %}), and you work 8 hours every day. You're not required to stay late, but if you're in a productive headspace and want to work an extra hour to finish work, you can ask your supervisor about working 1 more hour, therefore receiving 1 credit hour. The HR Links process formalizes and records this approval.
...
You may request travel comp time when you are approved to travel for work and that travel occurs outside regular working hours. Travel comp time is for “temporary duty,” also known as “TDY” travel, _not_ local travel or commuting. TDY travel is more than 12 hours long and requires a pre-approved authorization in Concur.
...
Traveling during your usual work day is considered regular hours, including traveling to the airport from your home.
